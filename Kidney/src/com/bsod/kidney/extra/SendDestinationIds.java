...
public class SendDestinationIds {
	
	public SendDestinationIds(){
		
	}
	
	
	public String SendDestinationIds_function(String url, String parm1, String parm2) {
		SendDestinationIds_bg c = new SendDestinationIds_bg();
		String reaspone = c.doInBackground(url, parm1, parm2);
		return reaspone;
	}

	private class SendDestinationIds_bg extends AsyncTask<String, Void, String> {
		@Override
